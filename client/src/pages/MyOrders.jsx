...
const MyOrders = () => {
  ...
  return myOrders.length === 0 ? (
    <>
      <div className="flex flex-col items-end w-max mb-8 mt-16">
          ...
          {order.items.map((item, index) => (
            ...
            >
              <div className="flex items-center mb-4 md:mb-0">
                <div className="bg-orange-500/70/10 p-4 rounded-lg">
                  <img
              ...
              <p className="text-orange-500/70 text-lg font-medium">
                Amount : {currency}
