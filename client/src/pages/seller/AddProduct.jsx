      ...
      <form onSubmit={submitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
        ...
        <div className="flex flex-col gap-1 max-w-md">
          ...
          <textarea
            ...
            placeholder="e.g. A sweet and crisp fruit with a rich and balanced flavor."
          ></textarea>
        </div>

        {/* --- Moved Rating and Weight fields here --- */}
        ...
        <button className="px-8 py-2.5 bg-orange-500/70 shadow-md hover:bg-orange-600/70 text-white font-medium rounded-md cursor-pointer">
          ADD
        </button>
      </form>
    </div>
