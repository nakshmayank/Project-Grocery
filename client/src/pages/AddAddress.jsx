...
const InputField = ({ type, placeholder, name, handleChange, address }) => (
  <input
    className="w-full px-2 py-2.5 border border-gray-500/30 rounded outline-none text-gray-500 focus:border-orange-500/70 transition"
    type={type}
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between mt-10">
        <div className="flex-1 max-w-md">
          <form className="space-y-3 mt-6 text-sm" onSubmit={submitHandler}>
            ...
            <button className="w-full mt-6 bg-orange-500/70 text-white py-3 hover:bg-orange-600/80 transition cursor-pointer uppercase">
              Save Address
            </button>
          </form>
        </div>
